...
st.sidebar.markdown(":point_right:&nbsp;&nbsp;&nbsp;[**View Transcribed Text**](#transcribed-text)",
                    unsafe_allow_html=True)
st.sidebar.markdown(':page_with_curl:&nbsp;&nbsp;&nbsp;Automatically convert your media files to text. Go further by '
...
st.sidebar.markdown(":point_right:&nbsp;&nbsp;&nbsp;[**View Word/Phrase Highlights**](#word-highlights)",
                    unsafe_allow_html=True)
st.sidebar.markdown(':page_with_curl:&nbsp;&nbsp;&nbsp;Word/Phrase Highlights picks out particular words and phrases '
